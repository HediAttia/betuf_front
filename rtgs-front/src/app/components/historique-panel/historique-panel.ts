...
export class HistoriquePanel implements OnInit {
  ...
  @Input() entiteType: string = 'RAPPORT';   // RAPPORT ou VISITE
  ...
  getStatutClass(statut: string): string {
    const classes: Record<string, string> = {
      'PLANIFIEE': 'step-planifiee',
      'REALISEE': 'step-realisee',
      'CLOTUREE': 'step-cloturee',
      'ANNULEE': 'step-annulee',
      'BROUILLON': 'step-brouillon',
      'SOUMIS': 'step-soumis',
      'A_CORRIGER': 'step-correction',
      'VALIDE': 'step-valide',
      'ANNULE': 'step-annulee'
    };
